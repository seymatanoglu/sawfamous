...
- (void)_parseDataForConnection:(MGTwitterHTTPURLConnection *)connection
{
    ...
    switch (responseType) {
        ...
        case MGTwitterUsers:
        case MGTwitterUser:
        case MGTwitterUserSearchResults:
                 ...
                 withParsedObjects:(NSArray *)parsedObjects
{
    ...
    switch (responseType) {
		...
		case MGTwitterSearchResults:
			...
			break;
        case MGTwitterUserSearchResults:
			if ([self _isValidDelegateForSelector:@selector(searchUserResultsReceived:forRequest:)])
				[_delegate searchResultsReceived:parsedObjects forRequest:identifier];
			break;
...
- (NSString *)getUserSearchResultsForQuery:(NSString *)query
{
...
//    return [self _sendRequestWithMethod:nil path:path queryParameters:params body:nil 
//                            requestType:MGTwitterUserSearchRequest 
//                           responseType:MGTwitterUserSearchResults];
}
